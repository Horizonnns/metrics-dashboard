import { Activity, BarChart3, Plus, TrendingUp, Users, Zap } from 'lucide-react'
...
const WelcomePage: React.FC = () => {
	...
	const features = [
		{
			...
			description:
				'Отслеживайте метрики вашего бота в режиме реального времени',
	...
	return (
		<>
			<div className='relative min-h-[85vh] pt-6 md:pt-0 flex flex-col items-center justify-center overflow-hidden'>
