...
const DashboardPage: React.FC = () => {
    ...
    return (
      <div className="flex flex-col items-center justify-center h-[60vh] text-center">
        ...
        <p className="text-gray-500 max-w-md mb-6">
          Мы не смогли подключиться к вашему боту. Пожалуйста, проверьте URL и секретный
          ключ в настройках бота.
        </p>
        <button
          onClick={() => refetch()}
  ...
  const metrics = data || {
    users: { total: 0, active_today: 0, active_7d: 0, active_30d: 0, premium: 0 },
    usage: { total_rewrites: 0, rewrites_today: 0, rewrites_by_day: {}, tones: {} },
  ...
  ).reduce((acc: number, day: PaymentDayData) => acc + (day.totalAmount || 0), 0);
