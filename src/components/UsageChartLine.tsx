    ...
    return (
      <div className="bg-gradient-to-br from-white to-secondary-50 px-5 py-4 rounded-2xl shadow-2xl border-2 border-primary-200 backdrop-blur-sm">
        ...
        <div className="flex items-baseline gap-2">
          ...
          <span className="text-sm font-medium text-secondary-500">запросов</span>
        </div>
      </div>
    );
  }
    ...
    <div className="bg-gradient-to-br from-white via-secondary-50/30 to-primary-50/20 p-6 rounded-3xl shadow-soft border border-secondary-100 relative h-full overflow-hidden">
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          ...
          <div className="flex items-center gap-4 mt-3">
            ...
            <span className="text-sm font-medium text-secondary-600">
              Среднее: <span className="font-bold text-secondary-900">{avgRequests}</span>
            </span>
          </div>
        </div>
        <div className="flex items-center gap-2 bg-white px-3 py-2 rounded-xl shadow-sm border border-secondary-100">
          ...
          <span className="text-xs text-secondary-600 font-semibold">7 дней</span>
        </div>
      </div>
          ...
          >
            <defs>
              <linearGradient id="colorGradient" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="#009a5c" stopOpacity={0.4} />
                <stop offset="50%" stopColor="#38e0a3" stopOpacity={0.2} />
                <stop offset="100%" stopColor="#76eebf" stopOpacity={0.05} />
              </linearGradient>
              <linearGradient id="strokeGradient" x1="0" y1="0" x2="1" y2="0">
                <stop offset="0%" stopColor="#009a5c" />
                <stop offset="100%" stopColor="#38e0a3" />
              </linearGradient>
              <filter id="glow">
