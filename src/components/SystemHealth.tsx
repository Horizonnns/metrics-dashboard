...
const CircularProgress: React.FC<{ percentage: number; strokeColor: string }> = ({
  percentage,
  strokeColor,
}) => {
  const radius = 20;
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-secondary-500 font-medium">Время работы</p>
              </div>
            </div>
        ...
        <div className="group relative bg-white/60 backdrop-blur-sm p-4 rounded-2xl border border-secondary-100 hover:shadow-lg transition-all duration-300 hover:scale-[1.02]">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <p className="text-xl font-black text-secondary-900">
                {data.latency}{" "}
                <span className="text-sm font-medium text-secondary-500">мс</span>
              </p>
              <div className="flex items-center gap-1.5 justify-end mt-1">
                <div
        ...
        <div className="group relative bg-white/60 backdrop-blur-sm p-4 rounded-2xl border border-secondary-100 hover:shadow-lg transition-all duration-300 hover:scale-[1.02]">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <p className="text-xl font-black text-secondary-900">
                {data.queue_size}{" "}
                <span className="text-sm font-medium text-secondary-500">задач</span>
              </p>
              <div className="flex items-center gap-1.5 justify-end mt-1">
                <div
