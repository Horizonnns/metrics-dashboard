...
import { Plus, Menu, X, Trash2, MoreVertical, Bot } from "lucide-react";
import { useSelector, useDispatch } from "react-redux";
import type { RootState, AppDispatch } from "../store/store";
import { selectBot, removeBot } from "../store/botsSlice";
                  ...
                  <div className="flex items-center gap-3 overflow-hidden flex-1">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <span className="text-xs text-secondary-500 font-medium">
                        {selectedBotId === bot.id ? "Активен" : "Готов к работе"}
                      </span>
                    </div>
                  </div>
                  <button
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="md:hidden flex items-center justify-between p-4 bg-surface border-b border-secondary-200">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-lg text-secondary-900">GigaMetrics</span>
          </div>
        </header>
